# Word Vectors via Co-occurrence → PMI → PPMI → Context-Expansion
...
- **Renan de Luca Avila** — idea, code implementation, experiments, and report preparation of walkthrough presentation.
- **Alexandre Cadaval** — Main presentation.
